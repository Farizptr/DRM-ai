...
def create_yolov8_dataset(overpass_query, zoom=18, train_ratio=0.7, val_ratio=0.15, test_ratio=0.15, output_dir="dataset4", min_size=0.01):
...
if __name__ == "__main__":
    ...
    [out:json];
    (
    way["building"](-1.0000,100.6000,-0.9000,100.7000); // Shifted even more east
    );
    out body;
    >;
    out skel qt;
